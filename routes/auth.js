...
module.exports = function (router, passport) {
	...
	router.get('/vk', passport.authenticate('vkontakte', { scope: ['friends', 'offline', 'status'], display: 'page' }));
	router.get('/vk/callback', passport.authenticate('vkontakte', {
		successRedirect: '/auth/profile',
		failureRedirect: '/'
	}));
	router.get('/connect/vk', passport.authorize('vkontakte', { scope: ['friends', 'offline', 'status'], display: 'page' }));
